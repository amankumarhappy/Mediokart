                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 z-50 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 pointer-events-none group-hover:pointer-events-auto group-focus-within:pointer-events-auto transition-all duration-200">
                    <div className="p-3">
                      ...
                      <Link to="/devices" className="flex items-center gap-2 px-3 py-2 rounded-lg text-base font-medium text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors duration-200">
                ...
                {currentUser && showAccountMenu ? (
                  <div className="pt-2">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-xl shadow p-3 mb-3">
                      ...
                      <Link to="/devices" onClick={() => { setIsOpen(false); setShowAccountMenu(false); }} className="flex items-center gap-2 px-3 py-2 rounded-lg text-base font-medium text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors duration-200"><TabletSmartphone size={18} /> My Devices</Link>
